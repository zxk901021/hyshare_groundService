...
public class DrivingRouteOverlay extends RouteOverlay {
    ...
    private void initPolylineOptions() {
        ...
        mPolylineOptions.setCustomTexture(BitmapDescriptorFactory.fromResource(R.mipmap.bluepath))
                //.color(getWalkColor())
                .width(getRouteWidth());
    ...
    private void colorWayUpdate(List<TMC> tmcSection) {
        ...
        mPolylineOptionscolor.setCustomTexture(BitmapDescriptorFactory.fromResource(R.mipmap.bluepath));
